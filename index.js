...
/* =========================
   PROCESAMIENTO ASINCRONO ORDEN
========================= */
async function procesarOrdenAsync(payload) {
  try {
    ...
    console.error("Webhook async error:", err.response?.data || err.message);
  }
}
