...
/* =========================
SINCRONIZACIÓN ROBUSTA REAL
========================= */

async function sincronizarCatalogo() {

  console.log("INICIANDO SINCRONIZACIÓN DEL CATÁLOGO SOBERANO...");
  ...
  console.log("CATÁLOGO 100% SINCRONIZADO Y SOBERANO");
  process.exit();
}
